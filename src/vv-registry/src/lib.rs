...
pub use block::{
    ...
    RUNTIME_PATTERN_CRACKED_CELLS, RUNTIME_PATTERN_FLAG_STAGGER, RUNTIME_PATTERN_GRID,
    RUNTIME_PATTERN_LAYERED_SURFACE, RUNTIME_PATTERN_NATURAL_CELLS,
    RUNTIME_PATTERN_ORIENTATION_AUTO, RUNTIME_PATTERN_ORIENTATION_HORIZONTAL,
    RUNTIME_PATTERN_ORIENTATION_MASK, RUNTIME_PATTERN_ORIENTATION_RADIAL,
    RUNTIME_PATTERN_ORIENTATION_SHIFT, RUNTIME_PATTERN_ORIENTATION_VERTICAL, RUNTIME_PATTERN_RINGS,
    RUNTIME_PATTERN_RUNNING_BOND, RUNTIME_PATTERN_STRIPS, RUNTIME_SURFACE_PROGRAM_FLAT,
    RUNTIME_SURFACE_PROGRAM_PATTERNED,
};
