...
impl Default for TreeFeatureDef {
    fn default() -> Self {
        Self {
            blocks: TreeBlocksDef::default(),
            size: TreeSizeDef::default(),
            trunk: TreeTrunkDef::default(),
            branches: TreeBranchDef::default(),
            crown: TreeCrownDef::default(),
            roots: TreeRootDef::default(),
            variation: TreeVariationDef::default(),
        }
    }
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(default, deny_unknown_fields)]
pub struct TreeBlocksDef {
    pub log: BlockRef,
    pub leaves: BlockRef,
    pub branch_log: Option<BlockRef>,
    pub root_log: Option<BlockRef>,
    pub fruit: Option<BlockRef>,
}

impl Default for TreeBlocksDef {
    fn default() -> Self {
        Self {
            log: BlockRef("voxelverse:wood_log".into()),
            leaves: BlockRef("voxelverse:leaves_oak".into()),
            branch_log: None,
            root_log: None,
            fruit: None,
        }
...
pub struct TreeArchetypeWeight {
